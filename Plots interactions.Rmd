...
```{r}
figure_numlic <- ggarrange(Plot.numlic1, Plot.numlic2,Plot.numlic3,common.legend = TRUE, legend = "right",
          ncol = 3, nrow = 1)
...
annotate_figure(figure_numlic,
                ...
                bottom = text_grob("Number of license holders", vjust = -9),
)
...
```{r}
figure_income <- ggarrange(Plot.income0, Plot.income1, Plot.income2, common.legend = TRUE, legend = "right", vjust=7,
          ncol = 3, nrow = 1)
...
figure <- ggarrange(Plot.qualinv1, Plot.qualinv2, Plot.qualinv3,Plot.qualinv4, common.legend = TRUE, legend = "none", vjust=8,
          ncol = 4, nrow = 1) %>% gridExtra::grid.arrange(get_legend(Plot.qualinv4), heights = unit(c(60, 5), "mm"))

annotate_figure(figure,
                #top = text_grob("Quality of public services and region as predictors of car ownership", color = "black", size = 14, vjust=6),
                left = text_grob("Predicted Probability", color = "black", rot = 90),
                bottom = text_grob("Quality of public services", vjust=-9),
)
...
```{r}
figure_car <- ggarrange(Plot.cs0, Plot.cs1, Plot.cs2,common.legend = TRUE, legend = "right", vjust=8,
          ncol = 3, nrow = 1)
...
annotate_figure(figure_work,
                left = text_grob("Predicted Probability", color = "black", rot = 90),
                bottom = text_grob("Number of workers", vjust=-9),
)
```
...
annotate_figure(figure_trip,
                ...
                left = text_grob("Predicted Probability", color = "black", rot = 90),
                bottom = text_grob("Average triplength in kilometers", vjust=-4),
)
```
...
annotate_figure(figure_children,
                ...
                left = text_grob("Predicted Probability", color = "black", rot = 90),
                bottom = text_grob("Household with children", vjust=-6),
)
```
...
annotate_figure(figure_ped,
                ...
                left = text_grob("Predicted Probability", color = "black", rot = 90),
                bottom = text_grob("Number of bicycles/pedelecs", vjust=-9),
)
```
