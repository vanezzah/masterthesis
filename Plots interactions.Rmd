...
multinom_int3<-multinom(formula = numcars ~ region2 + numlic + I(numlic^2) + 
    ...
    I(income_numerical^2) + region2:income_numerical + region2:I(income_numerical^2) + 
    quali_nv + region2:quali_nv + CSyes + region2:CSyes + workers + 
    ...
    garage + region2:garage + quali_opnv + region2:quali_opnv + 
    oldHH + region2:oldHH + CSmultiple + region2:CSmultiple + 
    hh_children + region2:hh_children + metro28 + region2:metro28 + 
    ...
    bus28 + region2:bus28, data = HH_dt_2_out, maxit = 700)
