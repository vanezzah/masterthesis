...
fit_multinom <- multinom(numcars ~numlic + I(numlic^2) + region2 + income_numerical+ quali_nv + CSyes + CSmultiple + workers +triplength_avg+ I(triplength_avg^2) + log(nummots1)+ housing_type + quali_opnv + youngHH + hh_children + garage + metro28 + train28 + tripsavg + parttime + numped + bus28, data = HH_dt_2_out)
...
cf2 <- matrix(fit_multinom2$wts, nrow=38) # davor 39 
...
e1 = as.data.frame(e1)
e2 = effect("income_numerical", fit_multinom2)
e2 = as.data.frame(e2)
...
e5 <- as.data.frame(e5)
e6 = effect("numped", fit_multinom2)
e6 <- as.data.frame(e6)

#e7 = effect("numch18", fit_multinom2)#?

e10 =  effect("workers", fit_multinom)
e10 <- as.data.frame(e10)
e11 =effect("parttime", fit_multinom2)
e11 <- as.data.frame(e11)

e12 = effect("share2039", fit_multinom)
e12 <- as.data.frame(e12)
#welches von beidem?
#e13 = effect("share4064", fit_multinom2)
#e13 <- as.data.frame(e13)
e13 = effect("shareold", fit_multinom2)
e13 <- as.data.frame(e13)

e13 = effect("youngHH", fit_multinom)
e13 <- as.data.frame(e13)
...
figure_trips <- ggarrange(CS1_plot, CS2_plot,common.legend = TRUE, legend = "none",
...
workers_plot <-ggplot(data=e10, aes(x=workers))+
      geom_line(aes(y=prob.X0, color="Zero cars")) + 
      geom_point(aes(y=prob.X1, color="One car")) + 
      geom_line(aes(y=prob.X2, color ="Two cars"))+
      geom_line(aes(y=prob.X3, color ="Three cars"))+
      ylab("")+
...
share1_plot <-ggplot(data=e12, aes(x=share2039))+
      geom_line(aes(y=prob.X0, color="Zero cars")) + 
      geom_line(aes(y=prob.X1, color="One car")) + 
      geom_point(aes(y=prob.X2, color ="Two cars"))+
      geom_line(aes(y=prob.X3, color ="Three cars"))+
      ylab("")+
...
share2_plot <-ggplot(data=e13, aes(x=youngHH, group=1))+
      geom_line(aes(y=prob.X0, color="Zero cars")) + 
      geom_line(aes(y=prob.X1, color="One car")) + 
      geom_line(aes(y=prob.X2, color ="Two cars"))+
      geom_line(aes(y=prob.X3, color ="Three cars"))+
...
figure_shares<- ggarrange(share1_plot, share2_plot,common.legend = TRUE, legend = "right", 
