...
HH_dt_2_temp <- HH_dt_2
HH_dt_2out_temp <-HH_dt_2_out
```
...
Check linearity plots and binned plots again 
...
#temp_influentials_2 <- temp_influentials
...
fm_new <- formula(numcars ~  1| numlic + region2 + income_numerical + I(numlic^2) + 
    quali_nv + I(income_numerical^2) + CSyes + workers + CSmultiple + 
    log(nummots1) + triplength_avg + housing_type + quali_opnv + 
    I(triplength_avg^2) + oldHH + parttime + hh_children + tripsavg + 
   numped + metro28 + train28 + garage + bus28 + I(parttime^2)|1)
