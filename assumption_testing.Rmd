...
dplyr::count(HH_dt_2, anzahlold, by=numcars)
...
corr_dt <- HH_dt_2[, c("trips", "numlic", "numch18", "workers", "parttime", "triplength_avg", "income_gr","hhsize", "nummots", "numped", "income_numerical", "bus28", "metro28", "train28","quali_opnv", "quali_nv", "num2039", "num4064", "num65","anzahlold")]
...
corr_dt_out <- HH_dt_2_out[, c("trips", "numlic", "numch18", "workers", "triplength_avg", "income_gr","hhsize", "nummots", "numped", "income_numerical", "bus28", "metro28", "train28","quali_opnv", "quali_nv", "num2039", "num4064", "num65")]
...
x_reg <- lm(numcars ~  numlic + region2 + income_numerical + quali_nv + workers + parttime +  hh_children + CS + triplength_avg + nummots + numped + num2039 + anzahlold + education + housing_type + quali_opnv + train28 + bus28 + metro28 + garage + tripsavg, data = HH_dt_2_out)
x <- vif(x_reg)
...
mylogit <- glm(numcars ~  income_numerical + triplength_avg  +tripsavg + nummots  + numped   + numch18   + numlic + workers + parttime + share2039  + share4064  + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv + hh_children, data = HH_dt_bin1, family = "binomial")

mylogit2 <- glm(numcars ~  income_numerical + triplength_avg  +tripsavg + nummots  + numped   + numch18   + numlic + workers + share2039  + share4064  + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv +hh_children, data = HH_dt_bin2, family = "binomial")

mylogit3 <- glm(numcars ~  income_numerical + triplength_avg  +tripsavg + nummots  + numped   + numch18   + numlic + workers + share2039  + share4064  + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv + hh_children, data = HH_dt_bin3, family = "binomial")
...
mylogit <- glm(numcars ~  numlic + I(numlic^2) + region2 + income_numerical+ quali_nv + CSyes + CSmultiple + workers +numch18 +triplength_avg+ I(triplength_avg^2) + log(nummots1)+ housing_type + quali_opnv + share2039 + share4064 + hh_children + garage + metro28 + train28 + tripsavg + parttime + numped + bus28, data = HH_dt_bin1, family = "binomial")
...
templogit1 <- c(19833 ,37738, 19137)
templogit1 <- c(19130, 19824,14918)
...
mylogit <- glm(numcars ~  numlic + I(numlic^2) + region2 + income_numerical+ quali_nv + CSyes + CSmultiple + workers +triplength_avg+ I(triplength_avg^2) + log(nummots1)+ housing_type + quali_opnv + share2039 + shareold + hh_children + garage + metro28 + train28 + tripsavg + parttime + numped + bus28, data = HH_dt_bin1, family = "binomial")
...
mylogit2 <- glm(numcars ~ income_gr +triplength_avg+ I(triplength_avg^2) + tripsavg +log(nummots1) + numped + numlic + I(numlic^2) + workers + parttime+ share2039 + shareold + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv + hh_children, data = HH_dt_bin2, family = "binomial")
...
templogit2 <- c(15347,20378,7235)
templogit2 <- c(15299,7207,20325)
...
temp100 = c(HHID_logit3,HHID_logit1, HHID_logit2)
