...
corr_dt <- HH_dt_2_out[, c("trips", "numlic", "numch18", "workersall", "parttime", "triplength_avg","hhsize", "nummots", "numped", "income_numerical", "bus28", "metro28", "train28","quali_opnv", "quali_nv")]
...
mylogit <- glm(numcars ~  income_numerical + triplength_avg  +tripsavg + nummots  + numped  + numlic + workers + parttime + oldHH + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv + hh_children + education, data = HH_dt_bin1, family = "binomial")

mylogit2 <- glm(numcars ~ income_numerical + triplength_avg  +tripsavg + nummots  + numped + numlic + workers + parttime + oldHH + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv + hh_children + education, data = HH_dt_bin2, family = "binomial")

mylogit3 <- glm(numcars ~  income_numerical + triplength_avg  +tripsavg + nummots  + numped + numlic + workers + parttime + oldHH + education + CSyes + CSmultiple + region2 + bus28 + train28 + metro28 + housing_type + garage + quali_opnv + quali_nv + hh_children + education, data = HH_dt_bin3, family = "binomial")
...
binnedplot(HH_dt_bin1$numlic,y)#ok
binnedplot(HH_dt_bin1$tripsavg,y)#ok
binnedplot(HH_dt_bin1$workers,y)#ok
...
binnedplot(HH_dt_bin2$numlic,y2)#ok
