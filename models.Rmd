...
HH_dt_2_out$shareold <- HH_dt_2_out$anzahlold/HH_dt_2_out$hhsize
HH_dt_2_out$share2039_v2 <- HH_dt_2_out$num2039/(HH_dt_2_out$hhsize-HH_dt_2_out$numch18)
HH_dt_2_out$youngHH <- "0"
HH_dt_2_out$youngHH[HH_dt_2_out$share2039_v2 > 0.5] <- "1"
HH_dt_2_out$youngHH <- factor(HH_dt_2_out$youngHH)
...
#now with shareold instead of share4064

fm_new <- formula(numcars ~  1| numlic + I(numlic^2) + region2 + income_numerical+ quali_nv + CSyes + CSmultiple + workers +triplength_avg+ I(triplength_avg^2) + log(nummots1)+ housing_type + quali_opnv + share2039 + shareold + hh_children + garage + metro28 + train28 + tripsavg + parttime + numped + bus28|1)
...
for (i in 1:10){
 ...
 b<- sample(subset(HH_dt_2_out, numcars == "1"), 254)
 c <- sample(subset(HH_dt_2_out, numcars == "2"), 154)
 d<- sample(subset(HH_dt_2_out, numcars == "3"), 39)
 df_test <- rbind(a,b,c,d)
 
 
 fit_HLsim <- multinom(numcars ~numlic + I(numlic^2) + region2 + income_numerical+ quali_nv + CSyes + CSmultiple + workers +triplength_avg+ I(triplength_avg^2) + log(nummots1)+ housing_type + quali_opnv + youngHH + hh_children + garage + metro28 + train28 + tripsavg + parttime + numped + bus28, data = df_test)
...
#Xiquadrat verteilung für Xi8(10-2) für 95% quantil: 15.51 / 2.73
...
fit_multinom_null <- multinom(numcars ~ 1, data = HH_dt_2_out,maxit=200)
